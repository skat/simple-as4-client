...
public class ExampleClient {
    public static void main(String[] args) throws AS4Exception {
        ...
        String res = client.executePush("DMS.Import", "Declaration.Submit",
                content.getBytes(StandardCharsets.UTF_8), Map.of("procedureType", "H7"));

        String res2 = client.executePush("DMS.Import", "Notification",
