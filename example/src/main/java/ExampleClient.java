...
public class ExampleClient {
    public static void main(String[] args) throws AS4Exception {
        ...
        String res = client.executePush("DMS.Import", "Declaration.Submit", content.getBytes(StandardCharsets.UTF_8), Map.of("procedureType", "H7"));
        String res2 = client.executePush("DMS.Import", "Notification", "", Map.of("lang", "EN", "submitterId", "13116482", "dateFrom", "2021-10-01T06:00:00.000", "dateTo", "2021-10-02T06:00:00.000"));
        StatusResponseType status =  Tools.getStatus(res);
        System.out.println("Result: " + status.getCode() + (status.getMessage() != null ? " and message: " + status.getMessage() : ""));
        NotificationResponse noti = Tools.getNotifications(res2);
        System.out.println("Result: " + noti.getNotification().size());
    }
