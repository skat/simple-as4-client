...
public class ExampleClient {
    public static void main(String[] args) throws IOException, TransformerException, URISyntaxException, JAXBException {
        As4Client client = new As4ClientBuilderInstance().builder().
            setEndpoint(new URI("https://secureftpgatewaytest.skat.dk:6384"))
                .setAs4Jaxb(new JaxbThreadSafe(JAXBContext.newInstance(Marshalling.defaultPackages)))
        ...
        StatusResponseType res = client.executePush("DMS.Import", "Declaration.Submit", content);
